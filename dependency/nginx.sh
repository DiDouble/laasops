...
docker run -d --name mynginx -p 80:80 -p 443:443 -v /data/tristan/laashub/nginx/default.conf:/etc/nginx/conf.d/default.conf -v /data/tristan/laashub/nginx/ca:/etc/nginx/ca nginx
